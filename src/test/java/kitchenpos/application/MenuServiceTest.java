...
public class MenuServiceTest {
	...
	void list() {
		...
		Menu menuWithTwoProducts = Fixtures.menuWithId("메뉴1", BigDecimal.valueOf(1000), SAVED_MENU_GROUP_ID
				, Arrays.asList(mockMenuProduct, mockMenuProduct), 1L);
		Menu menuWithThreeProducts = Fixtures.menuWithId("메뉴2", BigDecimal.valueOf(3000), SAVED_MENU_GROUP_ID
