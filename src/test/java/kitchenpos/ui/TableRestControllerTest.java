...
public class TableRestControllerTest extends BaseControllerTest {
    ...
    void create() throws Exception {
        ...
        OrderTable orderTable = Fixtures.orderTable(null, numberOfGuests, true);
    ...
    @Test
    @DisplayName("빈 테이블 설정을 해제할 수 있다. - 상태 변경 후 변경된 테이블 정보를 반환한다. ")
    void changeToNotEmpty() throws Exception {

        // given
        OrderTable orderTable = Fixtures.orderTableWithId(null, 0, false, EMPTY_ORDER_TABLE_ID);
    ...
    void changeToEmpty() throws Exception {
        ...
        // given
        OrderTable orderTable = Fixtures.orderTableWithId(null, 0, true, NOT_EMPTY_ORDER_TABLE_ID);
    ...
    void changeNumberOfGuests() throws Exception {
        ...
        OrderTable orderTable = Fixtures.orderTableWithId(null, numberOfGuests, false, NOT_EMPTY_ORDER_TABLE_ID);
