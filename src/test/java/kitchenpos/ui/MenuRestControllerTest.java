...
public class MenuRestControllerTest extends BaseControllerTest {
    ...
    void create() throws Exception {
        ...
        MenuProduct menuProduct1 = Fixtures.menuProduct(null, 1L, 2);
        MenuProduct menuProduct2 = Fixtures.menuProduct(null, 2L, 1);
        Menu menu = Fixtures.menu(name, price, 1L, Arrays.asList(menuProduct1, menuProduct2));
